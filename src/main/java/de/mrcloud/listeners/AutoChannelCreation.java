...
public class AutoChannelCreation extends ListenerAdapter {
    ...
    public void onGuildVoiceJoin(@Nonnull GuildVoiceJoinEvent e) {
        ...
        if (voiceChannel.getId().equals("731572359160528917") || voiceChannel.getId().equals("718170766469890072")) {

            VoiceChannel newVoiceChannel = category.createVoiceChannel("╠☕Chill Lounge " + (channelNumber + 1)).complete();
    ...
    public void onGuildVoiceMove(@Nonnull GuildVoiceMoveEvent e) {
        ...
        if (voiceChannelLeft.getName().matches("╠☕Chill Lounge \\d*")) {
    ...
    public void onGuildMessageReceived(@Nonnull GuildMessageReceivedEvent e) {
        ...
        if (e.getMessage().getContentRaw().matches("\\d*")) {
            ...
            VoiceChannel matchmakingChannel = server.getVoiceChannelsByName("╠☕Chill Lounge " + channelNumber, true).get(0);
